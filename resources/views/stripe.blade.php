                ...
                <div class="row our-system">
                    <ul class="nav nav-tabs">
                        ...
                        @if($admin_payment_setting['is_paypal_enabled'] == 'on' && !empty($admin_payment_setting['paypal_client_id']) && !empty($admin_payment_setting['paypal_secret_key']))
                            <li>
                                <a data-toggle="tab" id="contact-tab2" href="#paypal_payment">{{__('Payement')}}</a>
                            </li>
                        @endif
                                ...
                                <form class="w3-container w3-display-middle w3-card-4" method="POST" id="payment-form" action="{{ route('plan.pay.with.paypal') }}">
                                    ...
                                    <div class="border p-3 mb-3 rounded">
                                        <div class="row">
                                            <div class="col-md-10">
                                                <div class="form-group">
                                                    <label for="paypal_coupon" class="form-control-label">{{__('Pour Effectuer votre payement, Merci de nous contacter')}}</label>
                                                     </div>
                                            </div>
                                            <div class="col-auto my-auto">
                                                <a href="Mailto:contact@egest.ma" class="apply-btn apply-coupon" data-toggle="tooltip" data-title="{{__('Contacter nous')}}"><i class="fas fa-save"></i></a>
                                            </div>
                                                                                        <div class="col-md-10">
                                                <div class="form-group">
                                                    <label for="paypal_coupon" class="form-control-label">{{__('Contact@Egest.ma')}}</label>
                                                     </div>
                                            </div>
