                        ...
                        <div data-v-f2a183a6="" class="d" id="boxes" style="width:800px;margin-left: auto;margin-right: auto;">
                            <div data-v-f2a183a6="" class="d-header" style="background: {{$color}};color:{{$font_color}}">
                                <div data-v-f2a183a6="" class="d-header-inner">
                                    ...
                                    <div data-v-f2a183a6="" class="d-header-50 d-right">
                                        <div data-v-f2a183a6="" class="d-title">{{__('Bon de Livraison')}}</div>
                            ...
                            <div data-v-f2a183a6="" class="d-body">
                                <div data-v-f2a183a6="" class="d-bill-to">
                                    <div class="row">
                                        <div class="bill_to">
                                            <strong data-v-f2a183a6="">{{__('Client')}}:</strong>
                                            <p>
                                        ...
                                        @if($settings['shipping_display']=='off')
                                            <div class="ship_to">
                                                <strong data-v-f2a183a6="">{{__('Livrer à')}}:</strong>
                                                <p>
                                    ...
                                    <div data-v-f2a183a6="" class="d-table">
                                        <div data-v-f2a183a6="" class="d-table">
                                            ...
                                            <div data-v-f2a183a6="" class="d-table-tr" style="background: {{$color}};color:{{$font_color}}">
                                                <div class="d-table-th w-5">{{__('Article')}}</div>
                                                <div class="d-table-th w-2">{{__('Qty')}}</div>
                                                <div class="d-table-th w-3">{{__('Prix U')}}</div>
                                                <div class="d-table-th w-5">{{__('Taxe')}} (%)</div>
                                                @if($deliveryNote->discount_apply==1)
                                                    <div class="d-table-th w-2">{{__('Remise')}}</div>
                                                @else
                                                    <div class="d-table-th w-2"></div>
                                                @endif
                                                <div class="d-table-th w-3">{{__('Description')}}</div>
                                                <div class="d-table-th w-4 text-right">{{__('Price')}}<br><small class="text-danger">{{__('Avant taxes & Remise')}}</small>
                                                </div>
                                            </div>
                                                                ...
                                                                <pre data-v-f2a183a6="">
                                                                   @if(!empty($item->itemTax))
                                                                        @foreach($item->itemTax as $taxes)
                                                                            <span>{{$taxes['name']}}</span>  <span>({{$taxes['Taux']}})</span> <span>{{$taxes['Prix']}}</span>
                                                                        @endforeach
                                                                    @else
                                                                        -
                                                                    @endif
                                            ...
                                            <div data-v-f2a183a6="" class="d-table-footer">
                                                ...
                                                <div data-v-f2a183a6="" class="d-table-summary">
                                                    ...
                                                    @if($deliveryNote->getTotalDiscount())
                                                        <div data-v-f2a183a6="" class="d-table-summary-item">
                                                            <div data-v-f2a183a6="" class="d-table-label">{{__('Remise')}}:</div>
                                                    ...
                                                    <div data-v-f2a183a6="" class="d-table-summary-item">
                                                        <div data-v-f2a183a6="" class="d-table-label">{{__('Payé')}}:</div>
