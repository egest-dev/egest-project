...
@push('script-page')
    ...
    <script>
        ...
        var invoice_id = '{{$deliveryNote->id}}';
...
@section('content')
    <div class="row">
        {{ Form::model($deliveryNote, array('route' => array('delivery-note.update', $deliveryNote->id), 'method' => 'PUT','class'=>'w-100')) }}
        <div class="col-12">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        {{ Form::label('delivery_note_number', __('Delivery Note Number'),['class'=>'form-control-label']) }}
                                        <div class="form-icon-user">
                                ...
                                <div class="col-md-6">
                                    <div class="custom-control custom-checkbox mt-4">
                                        <input class="custom-control-input" type="checkbox" name="discount_apply" id="discount_apply" {{$deliveryNote->discount_apply==1?'checked':''}}>
        ...
        <div class="col-12">
            ...
            <div class="card repeater" data-value='{!! json_encode($deliveryNote->items) !!}'>
