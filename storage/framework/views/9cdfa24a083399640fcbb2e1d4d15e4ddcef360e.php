<?php $__env->startSection('page-title'); ?>
    <?php echo e(__('Delivery Note Edit')); ?>
...
<?php $__env->startPush('script-page'); ?>
    ...
    <script>
        ...
        var invoice_id = '<?php echo e($deliveryNote->id); ?>';
...
<?php $__env->startSection('content'); ?>
    <div class="row">
        <?php echo e(Form::model($deliveryNote, array('route' => array('delivery-note.update', $deliveryNote->id), 'method' => 'PUT','class'=>'w-100'))); ?>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group" id="customer-box">
                                <div class="input-group">
                                    ...
                                    <?php echo e(Form::select('customer_id', $customers,null, array('class' => 'form-control select2 ','id'=>'customer','data-url'=>route('invoice.customer'),'required'=>'required'))); ?>
                        ...
                        <div class="col-md-6">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <?php echo e(Form::label('delivery_note_number', __('Delivery Note Number'),['class'=>'form-control-label'])); ?>

                                        <div class="form-icon-user">
                                            <span><i class="fas fa-file"></i></span>
                                            <input type="text" class="form-control" value="<?php echo e($delivery_number); ?>" readonly>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    <div class="custom-control custom-checkbox mt-4">
                                        <input class="custom-control-input" type="checkbox" name="discount_apply" id="discount_apply" <?php echo e($deliveryNote->discount_apply==1?'checked':''); ?>>
        ...
        <div class="col-12">
            ...
            <div class="card repeater" data-value='<?php echo json_encode($deliveryNote->items); ?>'>
                    ...
                    <div class="table-responsive">
                        <table class="table table-striped mb-0 table-custom-style" data-repeater-list="items" id="sortable-table">
                            ...
                            <tr>
                                ...
                                <td width="25%">
                                    <?php echo e(Form::select('item', $product_services,null, array('class' => 'form-control item select2','data-url'=>route('invoice.product')))); ?>
        ...
        <div class="col-12 text-right">
            <input type="submit" value="<?php echo e(__('Update')); ?>" class="btn-create btn-xs badge-blue radius-10px">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/egestma/public_html/resources/views/deliverynote/edit.blade.php ENDPATH**/ ?>