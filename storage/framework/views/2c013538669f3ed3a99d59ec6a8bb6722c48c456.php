                        ...
                        <div data-v-f2a183a6="" class="d" id="boxes" style="width:800px;margin-left: auto;margin-right: auto;">
                            <div data-v-f2a183a6="" class="d-header" style="background: <?php echo e($color); ?>;color:<?php echo e($font_color); ?>">
                                <div data-v-f2a183a6="" class="d-header-inner">
                                    ...
                                    <div data-v-f2a183a6="" class="d-header-50 d-right">
                                        <div data-v-f2a183a6="" class="d-title"><?php echo e(__('Bon de Livraison')); ?></div>

                                        <div class="float-right mb-5">
                                            <?php echo DNS2D::getBarcodeHTML(route('invoice.link.copy',\Crypt::encrypt($deliveryNote->invoice_id)), "QRCODE",2,2); ?>
                                        ...
                                        <table data-v-f2a183a6="" class="summary-table">
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo e(Utility::deliveryNoteNumberFormat($settings,$deliveryNote->invoice_id)); ?></td>
                                            </tr>
                                            <tr>
                                                <td><?php echo e(__('Issue Date')); ?>:</td>
                                                <td><?php echo e(Utility::dateFormat($settings,$deliveryNote->issue_date)); ?></td>
                                            </tr>
                                            <tr>
                                                <td><?php echo e(__('Due Date')); ?>:</td>
                                                <td><?php echo e(Utility::dateFormat($settings,$deliveryNote->due_date)); ?></td>
                                            </tr>
                                            <?php if(!empty($customFields) && count($deliveryNote->customField)>0): ?>
                                                <?php $__currentLoopData = $customFields; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $field): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <tr>
                                                        <td><?php echo e($field->name); ?> :</td>
                                                        <td> <?php echo e(!empty($deliveryNote->customField)?$deliveryNote->customField[$field->id]:'-'); ?></td>
                                                    </tr>
                            ...
                            <div data-v-f2a183a6="" class="d-body">
                                <div data-v-f2a183a6="" class="d-bill-to">
                                    <div class="row">
                                        <div class="bill_to">
                                            <strong data-v-f2a183a6=""><?php echo e(__('Client')); ?>:</strong>
                                            <p>
                                        ...
                                        <?php if($settings['shipping_display']=='off'): ?>
                                            <div class="ship_to">
                                                <strong data-v-f2a183a6=""><?php echo e(__('Livrer à')); ?>:</strong>
                                                <p>
                                    ...
                                    <div data-v-f2a183a6="" class="d-table">
                                        <div data-v-f2a183a6="" class="d-table">
                                            ...
                                            <div data-v-f2a183a6="" class="d-table-tr" style="background: <?php echo e($color); ?>;color:<?php echo e($font_color); ?>">
                                                <div class="d-table-th w-5"><?php echo e(__('Article')); ?></div>
                                                <div class="d-table-th w-2"><?php echo e(__('Qty')); ?></div>
                                                <div class="d-table-th w-3"><?php echo e(__('Prix U')); ?></div>
                                                <div class="d-table-th w-5"><?php echo e(__('Taxe')); ?> (%)</div>
                                                <?php if($deliveryNote->discount_apply==1): ?>
                                                    <div class="d-table-th w-2"><?php echo e(__('Remise')); ?></div>
                                                <?php else: ?>
                                                    <div class="d-table-th w-2"></div>
                                                <?php endif; ?>
                                                <div class="d-table-th w-3"><?php echo e(__('Description')); ?></div>
                                                <div class="d-table-th w-4 text-right"><?php echo e(__('Price')); ?><br><small class="text-danger"><?php echo e(__('Avant taxes & Remise')); ?></small>
                                                </div>
                                            </div>

                                            <div class="d-table-body">
                                                <?php if(isset($deliveryNote->itemData) && count($deliveryNote->itemData) > 0): ?>
                                                    <?php $__currentLoopData = $deliveryNote->itemData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                ...
                                                                <pre data-v-f2a183a6="">
                                                                   <?php if(!empty($item->itemTax)): ?>
                                                                        <?php $__currentLoopData = $item->itemTax; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $taxes): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                            <span><?php echo e($taxes['name']); ?></span>  <span>(<?php echo e($taxes['Taux']); ?>)</span> <span><?php echo e($taxes['Prix']); ?></span>
                                                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                                    <?php else: ?>
                                                                        -
                                                                    <?php endif; ?>
                                            ...
                                            <div class="d-table-tr" style="border-bottom:1px solid <?php echo e($color); ?>;">
                                                ...
                                                <div class="d-table-td w-2">
                                                    <pre data-v-f2a183a6=""><?php echo e($deliveryNote->totalQuantity); ?></pre>
                                                </div>
                                                <div class="d-table-td w-3">
                                                    <pre data-v-f2a183a6=""><?php echo e(Utility::priceFormat($settings,$deliveryNote->totalRate)); ?></pre>
                                                </div>
                                                <div class="d-table-td w-5">
                                                    <pre data-v-f2a183a6=""><?php echo e(Utility::priceFormat($settings,$deliveryNote->totalTaxPrice)); ?></pre>
                                                </div>
                                                <?php if($deliveryNote->discount_apply==1): ?>
                                                    <div class="d-table-td w-2">
                                                        <pre data-v-f2a183a6=""><?php echo e(Utility::priceFormat($settings,$deliveryNote->totalDiscount)); ?></pre>
                                                    </div>
                                                <?php else: ?>
                                                    <div class="d-table-td w-2">
                                                        <pre data-v-f2a183a6="">-</pre>
                                                ...
                                                <div class="d-table-td w-4 text-right">
                                                    <span><?php echo e(Utility::priceFormat($settings,$deliveryNote->getSubTotal())); ?>
                                            ...
                                            <div data-v-f2a183a6="" class="d-table-footer">
                                                ...
                                                <div data-v-f2a183a6="" class="d-table-summary">
                                                    <div data-v-f2a183a6="" class="d-table-summary-item">
                                                        ...
                                                        <div data-v-f2a183a6="" class="d-table-value"><?php echo e(Utility::priceFormat($settings,$deliveryNote->getSubTotal())); ?></div>
                                                    </div>
                                                    <?php if($deliveryNote->getTotalDiscount()): ?>
                                                        <div data-v-f2a183a6="" class="d-table-summary-item">
                                                            <div data-v-f2a183a6="" class="d-table-label"><?php echo e(__('Remise')); ?>:</div>
                                                            <div data-v-f2a183a6="" class="d-table-value"><?php echo e(Utility::priceFormat($settings,$deliveryNote->getTotalDiscount())); ?></div>
                                                        </div>
                                                    <?php endif; ?>
                                                    <?php if(!empty($deliveryNote->taxesData)): ?>
                                                        <?php $__currentLoopData = $deliveryNote->taxesData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $taxName => $taxPrice): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <div data-v-f2a183a6="" class="d-table-summary-item">
                                                    ...
                                                    <div data-v-f2a183a6="" class="d-table-summary-item">
                                                        <div data-v-f2a183a6="" class="d-table-label"><?php echo e(__('Total')); ?>:</div>
                                                        <div data-v-f2a183a6="" class="d-table-value"><?php echo e(Utility::priceFormat($settings,$deliveryNote->getSubTotal()-$deliveryNote->getTotalDiscount()+$deliveryNote->getTotalTax())); ?></div>
                                                    </div>
                                                    <div data-v-f2a183a6="" class="d-table-summary-item">
                                                        <div data-v-f2a183a6="" class="d-table-label"><?php echo e(__('Payé')); ?>:</div>
                                                        <div data-v-f2a183a6="" class="d-table-value"><?php echo e(Utility::priceFormat($settings,($deliveryNote->getTotal()-$deliveryNote->getDue())-($deliveryNote->deliveryNoteTotalCreditNote()))); ?></div>
                                                    </div>
                                                    <div data-v-f2a183a6="" class="d-table-summary-item">
                                                        <div data-v-f2a183a6="" class="d-table-label"><?php echo e(__('Credit Note')); ?>:</div>
                                                        <div data-v-f2a183a6="" class="d-table-value"><?php echo e(Utility::priceFormat($settings,($deliveryNote->deliveryNoteTotalCreditNote()))); ?></div>
                                                    </div>
                                                    <div data-v-f2a183a6="" class="d-table-summary-item">
                                                        <div data-v-f2a183a6="" class="d-table-label"><?php echo e(__('Due Amount')); ?>:</div>
                                                        <div data-v-f2a183a6="" class="d-table-value"><?php echo e(Utility::priceFormat($settings,$deliveryNote->getDue())); ?></div>
                                                    </div>
                                                </div>
                                            </div>
...
<?php if(!isset($preview)): ?>
    <?php echo $__env->make('deliverynote.script', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>;
<?php endif; ?>
</body>
</html>
<?php /**PATH /home/egestma/public_html/resources/views/deliverynote/templates/template1.blade.php ENDPATH**/ ?>