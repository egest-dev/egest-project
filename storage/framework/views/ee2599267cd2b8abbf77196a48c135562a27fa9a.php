    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12 inner-text">
                ...
                <a href="<?php echo e(route('register')); ?>" class="button" id="text-4"></a>
                <span id="text-5"></span>
            </div>
...
<?php /**PATH /home/egestma/public_html/resources/views/custom_landing_page/custome-top-header-section.blade.php ENDPATH**/ ?>