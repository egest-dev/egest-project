...
<?php echo e(Form::open(array('route' => array('delivery-note.payment', $deliveryNote->id),'method'=>'post','enctype' => 'multipart/form-data'))); ?>
...
<div class="row">
    ...
    <div class="form-group  col-md-6">
        ...
        <div class="input-group">
            ...
            <?php echo e(Form::text('amount',$deliveryNote->getDue(), array('class' => 'form-control','required'=>'required'))); ?>
...
<?php /**PATH /home/egestma/public_html/resources/views/deliverynote/payment.blade.php ENDPATH**/ ?>