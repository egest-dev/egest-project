    ...
    <div class="all-button-box row d-flex justify-content-end">
        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('create role')): ?>
            <div class="col-xl-2 col-lg-2 col-md-4 col-sm-6 col-6">
                <a href="#" data-url="<?php echo e(route('roles.create')); ?>" data-size="xl" data-ajax-popup="true" data-title="<?php echo e(__('Create New Role')); ?>" class="btn btn-xs btn-white btn-icon-only width-auto" onclick="collapseSideNav()">
                                ...
                                <tr class="font-style">
                                    ...
                                    <td class="Action">
                                        ...
                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('edit role')): ?>
                                                <a href="#" class="edit-icon" data-url="<?php echo e(route('roles.edit',$role->id)); ?>" data-size="xl" data-ajax-popup="true" data-toggle="tooltip" data-original-title="<?php echo e(__('Edit')); ?>" data-title="<?php echo e(__('Edit Role')); ?>" onclick="collapseSideNav()">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\egest\resources\views/role/index.blade.php ENDPATH**/ ?>