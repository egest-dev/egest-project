    ...
    public function saveBusinessSettings(Request $request)
    {
        ...
        if(\Auth::user()->can('manage business settings'))
        {
            ...
            $dir        = storage_path('app/public/uploads/logo/');
                ...
                $logoName     = $user->id . $fileNameToStore;
            ...
            if($request->company_small_logo)
            {
                ...
                $path          = $request->file('company_small_logo')->storeAs('app/public/uploads/avatar/', $smallLogoName);
            ...
            if($request->company_favicon)
            {
                ...
                $path    = $request->file('company_favicon')->storeAs('app/public/uploads/avatar/', $favicon);
