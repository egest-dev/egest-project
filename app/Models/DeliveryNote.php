...
class DeliveryNote extends Model
{
    ...
    public function tax()
    {
        return $this->hasOne('App\Models\Tax', 'tax_id');
    }

    public function items()
    {
        return $this->hasMany('App\Models\DeliveryNoteProduct', 'invoice_id', 'id');
    }
    ...
    public function getDue()
    {
        ...
        return ($this->getTotal() - $due) - $this->deliveryNoteTotalCreditNote();
    }
...
//    }
    ...
    public function deliveryNoteTotalCreditNote()
    {
    ...
    {
        return $this->hasOne('App\Models\ProductServiceCategory', 'category_id');
    }
}
